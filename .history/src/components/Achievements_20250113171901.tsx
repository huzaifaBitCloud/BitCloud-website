...
const Achievements = () => {
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Card 1 */}
      <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl shadow-lg text-center transform transition duration-700 hover:-translate-y-3 custom-cards-ourClient max-w-sm mx-auto"> {/* Reduced padding and rounded the corners */}
