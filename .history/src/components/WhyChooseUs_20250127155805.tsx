...
//         </div>
//         <div className="flex flex-col items-start mx-auto h-[100%] mt-8">
...
//               <div className="ml-6 " style={{ height: "96px" }}>
        ...
        <div className="flex flex-col items-start">
          {steps.map((step, index) => (
            ...
            >
              {/* Vertical Line */}
              {index !== steps.length - 1 && (
                <span className="absolute left-6 top-12 h-20 w-0.5 bg-slate-400 hidden sm:block"></span>
              )}
