  ...
  return (
    <section className="bg-gray-50 py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl shadow-lg text-center transform transition duration-700 hover:-translate-x-4 custom-cards-ourClient">
  <div className="flex justify-center items-center mb-4">
    <FaHandsHelping className="w-10 h-10 text-gray-500" />
  </div>
  <h3 className="text-3xl font-bold text-gray-900">120+</h3>
  <p className="text-gray-600 mt-2 text-base">Implementations</p>
</div>

          
          {/* <div className="bg-gradient-to-r from-green-50 to-green-100 p-8 rounded-2xl shadow-lg text-center transform transition duration-700 hover:-translate-x-6 custom-cards-ourClient">
