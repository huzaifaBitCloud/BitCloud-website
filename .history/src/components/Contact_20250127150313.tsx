      ...
      <section className="bg-white">
        <div className="py-8 lg:py-16 px-4 mx-auto w-[90%] grid md:grid-cols-2 gap-10">
          <div className="flex flex-col items-center">
            ...
            <p className="mb-8 lg:mb-12 font-normal text-justify text-black w-[60%] mt-10">
              ...
              we’re here to help. Simply fill out the form below with your
              message, and our dedicated team will get back to you promptly. Let
              us know how we can assist you in achieving your goals. We look
              forward to hearing from you and collaborating to bring your ideas
              to life with innovative and tailored software solutions.
            </p>
