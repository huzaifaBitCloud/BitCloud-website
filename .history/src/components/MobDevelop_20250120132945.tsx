...
const MobDevelop = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-4xl font-bold text-center mb-8 bg-clip-text text-blue-500 bg-gradient-to-r from-[#0938CF] to-[#13CFC7]">
          Mobile Development & Updates
        </h1>

        {/* Introduction Section */}
        <section className="mb-12 text-center pl-6">
          <p className="text-lg text-indigo-500 max-w-2xl mx-auto font-semibold">
