...
const About = () => {
      ...
      >
        ...
        <div className="relative z-10 sm:w-[100%] md:w-[80%] lg:w-[50%] mx-auto text-left sub-hero-about">
          ...
          <div className="flex mob-btn-about gap-4">
            ...
            <button
              className="btn-about border border-white px-6 py-2 rounded-md hover:bg-white hover:text-blue-800 transition"
              onClick={() => router.push("https://www.linkedin.com/company/bitcloud-solution-software/")}
            >
              Follow Us
            </button>
          </div>
  ...
  <div className="text-center">
    ...
    <p className="my-7 text-lg leading-relaxed max-w-3xl mx-auto">
      At [Your Company Name], we are committed to simplifying the construction process by offering precise and detailed estimates, ensuring you stay within budget and avoid unnecessary costs. We strive to help homeowners, builders, and contractors make informed decisions by delivering fast and accurate quotes.
    </p>
  </div>
  ...
  <div className="text-center">
    ...
    <p className="my-7 text-lg leading-relaxed max-w-4xl mx-auto">
      ...
      <br />
      <strong>Doors & Windows:</strong> Installation costs, material choices, and design options. 
      <br />
      <strong>TV Lounges:</strong> Complete cost breakdowns, including flooring, wall finishing, and more. 
      <br />
      <strong>Bedrooms & Living Spaces:</strong> Detailed estimation for materials, labor, and time. 
      <br />
      <strong>Kitchens:</strong> Custom estimates for cabinets, countertops, and appliances. 
      <br />
      <strong>Bathrooms:</strong> Cost assessments for fixtures, tiles, plumbing, and more. 
      <br />
      <strong>Exterior Elements:</strong> Including patios, landscaping, fencing, and driveway estimates.
    </p>
  </div>
  ...
  <div className="text-center">
    ...
    <p className="my-7 text-lg leading-relaxed max-w-4xl mx-auto">
      <strong>Accuracy:</strong> Our estimates are detailed and reliable, so you know exactly what to expect. 
      <br />
      <strong>Expertise:</strong> We leverage years of industry experience to deliver accurate results. 
      <br />
      <strong>Customer-Centric:</strong> Your needs are our priority. We work with you to customize estimates based on your unique requirements. 
      <br />
      <strong>Fast Turnaround:</strong> We value your time. Our streamlined process ensures you receive your estimate promptly.
    </p>
    <p className="my-7 text-lg leading-relaxed max-w-4xl mx-auto">
      <strong>Our Vision:</strong> We aim to become the go-to solution for construction estimates across the industry. With our commitment to quality and precision, we want to empower our clients to build confidently, knowing that their project costs are well understood from the start.
    </p>
  </div>
</div>
