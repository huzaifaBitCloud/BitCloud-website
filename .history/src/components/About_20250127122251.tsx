...
const About = () => {
    ...
    <section id="about" className=" w-[100%] mx-auto mb-6">
      ...
      >
        ...
        <div className="relative z-10 sm:w-[90%] md:w-[70%] lg:w-[60%] mx-auto text-center sub-hero-about">
          ...
          <p className="px-6 mb-8 text-base md:text-lg text-white dark:text-gray-300 leading-relaxed">
  ...
  <p className="px-6 my-7 text-lg leading-relaxed text-justify max-w-2xl mx-auto">
    At <strong>BitCloud Solution</strong>, our mission is to empower businesses with innovative and reliable software solutions. We strive to simplify complex processes, enabling organizations to operate more efficiently and effectively. By leveraging cutting-edge technology, we aim to deliver exceptional value, foster growth, and create lasting partnerships with our clients.
  </p>
</div>

        {/* <div className="text-center">
          <h2 className="text-3xl font-bold my-6">Our Mission</h2>
          <p className="px-2 my-7 text-lg leading-relaxed max-w-3xl mx-auto">
