    ...
    <section className="bg-gray-50 py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className=" from-green-50 to-green-100 p-8 rounded-2xl shadow-lg text-center transform transition duration-700 hover:-translate-y-6 custom-cards-ourClient">
