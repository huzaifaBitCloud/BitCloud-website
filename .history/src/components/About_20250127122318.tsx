      ...
      <div className="mt-5 px-4 sm:px-6 md:px-10 lg:px-16">
        ...
        <div className="text-center">
          ...
          <p className="px-6 my-7 text-lg leading-relaxed text-justify max-w-2xl mx-auto">
            At <strong>BitCloud Solution</strong>, our mission is to empower
            businesses with innovative and reliable software solutions. We
            strive to simplify complex processes, enabling organizations to
            operate more efficiently and effectively. By leveraging cutting-edge
            technology, we aim to deliver exceptional value, foster growth, and
