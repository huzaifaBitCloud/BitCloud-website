...
const Contact = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: <MdEmail className="w-14 h-14 text-red-500" />,
    ...
    },
    {
      ...
      icon: <FaLinkedin className="w-14 h-14 text-gray-500" />,
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-10 pb-20">
          {cards.map((card) => (
            ...
            >
              <div
                className={`bg-gradient-to-r ${card.bgGradient} p-10 rounded-2xl  text-center transform transition duration-500 group-hover:scale-105 `}
                style={{
                  width: "100%",
                  maxWidth: "400px",
                  margin: "0 auto",
